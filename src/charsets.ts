...
export function encodeUTF8(value: string, buffer: Uint8Array, offset: number, end?: number, state?: { _code: number; _length: number; _position: number; _done: boolean; }): number {
...
export function decodeUTF8(buffer: Uint8Array, offset: number, end?: number, state?: { _text?: string; _code?: number; _length?: number; }): string {
    end = end || buffer.length;
